...
# YACHT setup
echo "----------------------------------------------------------------"
echo "Commence Yacht Setup"
echo "----------------------------------------------------------------"
sudo docker volume create yacht
sudo docker run -d -p 8050:8000 -v /var/run/docker.sock:/var/run/docker.sock -v yacht:/config --name yacht selfhostedpro/yacht
echo " "
echo "----------------------------------------------------------------"
echo "Yacht Interface is reachable at homebridge.local:8050"
echo "----------------------------------------------------------------"
echo " "
echo " "
echo "----------------------------------------------------------------"
